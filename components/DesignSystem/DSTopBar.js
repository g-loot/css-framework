export default function DSTopBar() {
  return (
    <div className='sticky top-0 z-50 bg-ui-800/50 flex items-center backdrop-blur'>
      <div className='py-2 container mx-auto flex space-x-12 relative text-white items-stretch justify-between px-4 md:px-0'>
        ...
        <div className='w-1/2 md:w-9/12 xl:w-10/12 flex items-center justify-between'>
          <div className='flex items-center'>
            <div className='hidden md:block font-headings italic text-xl text-ui-300'>
              Front-end Framework
            </div>
          </div>
          <div className='flex items-center justify-end'>
            <div className='block md:hidden font-headings italic text-xl text-ui-300'>
              Front-end Framework
            </div>
          </div>
        </div>
