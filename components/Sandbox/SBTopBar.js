...
import SBMainNavMobile from './SBMainNavMobile';
import packageFramework from '../../framework/package.json';

export default function SBTopBar({children, data}) {
  return (
          ...
          <div className='w-1/2 md:w-3/12 xl:w-2/12 flex items-center gap-2'>
            ...
            <Link href='../'>
              <a className='block interactive'>
                <img width="123" height="64" src="https://res.cloudinary.com/gloot/image/upload/v1672130648/Stryda/logos/stryda-logo-white.svg" alt="Stryda logo" />
              </a>
            </Link>
          </div>
