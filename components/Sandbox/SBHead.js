...
export default function SBHead(props) {  
  return (
    <Head>
      ...
      <meta property="og:image" content="https://res.cloudinary.com/gloot/image/upload/f_auto/v1672669464/Stryda/framework/Stryda_framework_ogpreview.jpg" />
      ...
      <meta name="twitter:image" content="https://res.cloudinary.com/gloot/image/upload/f_auto/v1672669464/Stryda/framework/Stryda_framework_ogpreview.jpg" />
    </Head>
  );
}
