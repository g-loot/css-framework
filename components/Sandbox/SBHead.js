...
export default function SBHead(props) {  
  return (
    <Head>
      <title>{props.title} — Stryda framework & prototype</title>
      ...
      <meta property="og:title" content="Stryda framework & prototype" />
      ...
      <meta name="twitter:title" content="Stryda framework & prototype" />
