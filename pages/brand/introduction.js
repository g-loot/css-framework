...
const BrandPage = () => (
  <div>
    <img className='mb-8' src='https://res.cloudinary.com/gloot/image/upload/v1655896333/Marketing/2022_prototype/Brand/brand-styleguide.webp' width="100%" height='auto' alt='G-Loot style guide' />
    <div className='max-w-md mx-auto space-y-24 text-ui-100 leading-none mb-6'>
      <div className='flex gap-8 flex-col lg:flex-row items-stretch justify-start'>
        ...
        <div className='flex-1 leading-loose text-ui-300 space-y-4'>
          <p>
            This guide is created for everyone at G-Loot to help maintain a coherent design language across all platforms and touch points, to speed up production and build brand awareness through consistency.
          </p>
          <p>
            The expression of G-Loot is modern, exciting and engaging. We want to let our players and users feel that every part of the G-Loot experience is crafted with care.
          </p>
        </div>
      </div>
