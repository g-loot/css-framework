    ...
    <>
      <div className="sticky top-0 z-50 bg-ui-700/95 navbar h-12 flex items-center border-b border-ui-500 shadow-xs">
        {prototype.isLoggedOut ? (
          <div className="w-full px-4 relative flex justify-between items-center lg:gap-4">
            <img
              src="https://res.cloudinary.com/gloot/image/upload/v1673531083/Stryda/logos/stryda-logo-main-white-png.png"
              className="w-auto h-8"
              alt="Stryda"
            />
            <div className="flex items-center relative justify-end md:ml-8 ml-auto space-x-2 text-sm xl:relative">
              <a
                href="https://play.stryda.gg/?method=login"
                className="button button-sm button-secondary"
              >
                <span>Log in</span>
              </a>
              <a
                href="https://gloot-desktop-releases-4g0pox0x0-g-loot.vercel.app/download/win32?update=true"
