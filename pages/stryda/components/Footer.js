...
export default function Footer(props) {
  ...
  return (
    <footer
      className={`relative z-[49] bg-ui-800 border-t border-ui-700 ${
        props.className ? props.className : ""
      }`}
    >
      <div className="py-12 container mx-auto md:gap-12 px-4 2xl:px-0 md:flex justify-between">
      ...
      <div className="px-4 py-6 text-center text-sm bg-ui-700 text-ui-300">
        <p>
          Games listed on Stryda are registered trademarks of respective
          publishers and IP holders. This site is in no way associated or
          endorsed by game publishers.
        </p>
      </div>
    </footer>
  );
