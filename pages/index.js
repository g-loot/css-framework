...
const Index = () => {
  ...
  return(
    ...
    <div className='drawer'>
      <input id='drawer-framework' type='checkbox' className='drawer-toggle' />
              ...
              <div className='col-span-12 lg:col-span-12 flex flex-col'>
                <div className='flex-1 lg:border-l border-ui-700 lg:pl-8 mb-12'>
                  <h1 className='mb-8 leading-none mt-0'>
                    <small className='text-ui-200 text-3xl'>Welcome to the</small>
                    <div>G-Loot design system</div>
                  </h1>
                  <p className='text-ui-300 leading-relaxed max-w-md'>
                    The G-Loot design system is a collection of reusable components, guided by a style guide, founded on a design strategy. Here you will find all relevant resources needed to build any number of applications or pages. The design system aims to create efficient work flows, consistency and alignment when designing for the end user.
                  </p>
                </div>
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch'>
                  <div className='rounded-xl surface overflow-hidden transform-gpu flex flex-col gap-4 items-stretch w-full p-2 animate-slide-in-bottom animate-delay' style={{ '--delay': 'calc( 1 * 0.05s)'}}>
                    <div className='flex-none aspect-landscape bg-cover bg-center rounded' style={{ backgroundImage: `url(https://res.cloudinary.com/gloot/image/upload/v1653289722/Marketing/2022_prototype/cover-designsystem.webp)`}}>
                    </div>
                    <div className='flex-1 flex flex-col items-start justify-start p-2'>
                      <div className='flex items-baseline gap-2 mb-3'>
                        <h2 className='text-2xl leading-none'>CSS Framework</h2>
                      </div>
                  ...
                  <div className='rounded-xl surface overflow-hidden transform-gpu flex flex-col gap-4 items-stretch w-full p-2 animate-slide-in-bottom animate-delay' style={{ '--delay': 'calc( 2 * 0.05s)'}}>
                    <div className='flex-none aspect-landscape bg-cover bg-center rounded' style={{ backgroundImage: `url(https://res.cloudinary.com/gloot/image/upload/v1653289722/Marketing/2022_prototype/cover-prototype.webp)`}}>
                    </div>
                    <div className='flex-1 flex flex-col items-start justify-start p-2'>
                      <div className='flex items-baseline gap-2 mb-3'>
                  ...
                  <div className='rounded-xl surface overflow-hidden transform-gpu flex flex-col gap-4 items-stretch w-full p-2 animate-slide-in-bottom animate-delay' style={{ '--delay': 'calc( 3 * 0.05s)'}}>
                    <div className='flex-none aspect-landscape bg-cover bg-center rounded' style={{ backgroundImage: `url(https://res.cloudinary.com/gloot/image/upload/v1653289722/Marketing/2022_prototype/cover-brand.webp)`}}>
                    </div>
                    <div className='flex-1 flex flex-col items-start justify-start p-2'>
                      <div className='flex items-baseline gap-2 mb-3'>
      ...
      <div className='drawer-side scrollbar-hidden'>
        ...
        <aside className='w-80 bg-ui-800 border-r border-ui-700'>
          <div className='sticky z-20 top-0 p-2 backdrop-blur-sm'>
            <label htmlFor="drawer-framework" className="drawer-button button button-tertiary button-close">
          ...
          <div className='px-2 pb-2'>
            <ul className="menu menu-rounded">
                {FrameworkPages.pages.map((page, pageIndex) => (
                  <li key={page} className={`${page.isDisabled ? 'is-disabled' : ''}`}>
                    <Link href={page.url}>
