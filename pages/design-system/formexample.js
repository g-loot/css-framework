...
const DSpage = () => {
  return (
    <>
      <h1 className="mb-8">Form example</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="flex-3 surface rounded-lg p-4 lg:p-8">
            <form action="#" method="POST">
              <section className="space-y-4">
                <h2 className="h4 mb-8">Profile</h2>
              ...
              <section className="space-y-4">
                <h2 className="h4 mt-8">Social</h2>
              ...
              <section className="space-y-4">
                <h2 className="h4 mt-8">Data Privacy</h2>
                <p className="text-sm text-ui-200">
                  To make Stryda better we collect information from you as
                  visitor with help from cookies. We also conduct relevant
                  marketing of Stryda&lsquo;s services within Meta, Google,
                  Adroll, Snapchat and Bing&lsquo;s network. Read more in our{" "}
                  <a href="#" target="_blank">
                    Privacy Policy
                  </a>
                  . <br />
                  Here you can consent to share your data with the following
                  partners:
                </p>
                <div className="form-group">
          ...
          <div className="flex-2">
            <iframe
              ...
              width="100%"
              height="800"
              src="//jsfiddle.net/augustin_hiebel/mz3vr67f/embedded/html/dark/?bodyColor=212333&menuColor=1C1D2C&fontColor=FFFFFF&accentColor=F3C351"
            ></iframe>
          </div>
        </div>
      </div>
