      ...
      <div className='surface rounded-lg p-4'>
        <div className='flex flex-col lg:flex-row gap-4'>
          ...
          <div className='flex-1'>
            <iframe className="rounded" width="100%" height="300" src="//jsfiddle.net/augustin_hiebel/ofseLxwn/embedded/html/dark/?bodyColor=333366&menuColor=1F1F42&fontColor=FFFFFF&accentColor=13F094" ></iframe>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className='mb-12' id='navbar-with-title-button'>
      ...
      <div className='surface rounded-lg p-4'>
        <div className='flex flex-col lg:flex-row gap-4'>
          ...
          <div className='flex-1'>
            <iframe className="rounded" width="100%" height="300" src="//jsfiddle.net/augustin_hiebel/s5yzfknL/embedded/html/dark/?bodyColor=333366&menuColor=1F1F42&fontColor=FFFFFF&accentColor=13F094" ></iframe>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className='mb-12' id='navbar-with-icons-start-end'>
      ...
      <div className='surface rounded-lg p-4'>
        <div className='flex flex-col lg:flex-row gap-4'>
          ...
          <div className='flex-1'>
            <iframe className="rounded" width="100%" height="300" src="//jsfiddle.net/augustin_hiebel/pqf26h4v/embedded/html/dark/?bodyColor=333366&menuColor=1F1F42&fontColor=FFFFFF&accentColor=13F094" ></iframe>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className='mb-12' id='navbar-with-menu'>
      ...
      <div className='surface rounded-lg p-4'>
        <div className='flex flex-col lg:flex-row gap-4'>
                  ...
                  <ul className="menu menu-horizontal" role="menu">
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a><span>Submenu 3</span></a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      <a><span>Missions</span></a>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className='flex-1'>
            <iframe className="rounded" width="100%" height="300" src="//jsfiddle.net/augustin_hiebel/k1w4negm/embedded/html/dark/?bodyColor=333366&menuColor=1F1F42&fontColor=FFFFFF&accentColor=13F094" ></iframe>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className='mb-12' id='navbar-with-search-dropdown'>
      ...
      <div className='surface rounded-lg p-4'>
        <div className='flex flex-col lg:flex-row gap-4'>
          <div className='flex-1 flex justify-center items-center'>
            <div className="navbar bg-ui-900/95 rounded-lg shadow-lg">
              <div className='navbar-content container'>
                ...
                <div className='flex-none'>
                  <input type='password' name='search-field' id='search-field' placeholder='Search' className='input-sm' />
                </div>
          ...
          <div className='flex-1'>
            <iframe className="rounded" width="100%" height="300" src="//jsfiddle.net/augustin_hiebel/a5g2ntuv/embedded/html/dark/?bodyColor=333366&menuColor=1F1F42&fontColor=FFFFFF&accentColor=13F094" ></iframe>
          </div>
        </div>
      </div>
    </div>
