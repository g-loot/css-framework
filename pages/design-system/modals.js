        ...
        <div className='flex flex-col lg:flex-row gap-4'>
          <div className='flex-3'>
            <div className='surface rounded-lg p-4 text-center'>
              <button type="button" className='button button-primary' onClick={openModal1}>
        ...
        <div className='flex flex-col lg:flex-row gap-4'>
          <div className='flex-3'>
            <div className='modal modal-inverted surface'>
              <button type="button" className="button button-secondary button-close">
                <span className='icon icon-e-remove'/>
              </button>
              <div className='modal-image'>
                <span style={{ backgroundImage: `url(https://res.cloudinary.com/gloot/image/upload/v1644831593/Marketing/202109_gloot2/tournament-pubg_1.jpg)`}}/>
    ...
    <div className='mb-12' id='with-inner-image'>
      ...
      <div className='mb-10'>
        <div className='flex flex-col lg:flex-row gap-4'>
          ...
          <div className='flex-2'>
            <iframe className="rounded-lg" width="100%" height="345" src="//jsfiddle.net/augustin_hiebel/sq703g2h/embedded/html/dark/?bodyColor=333366&menuColor=1F1F42&fontColor=FFFFFF&accentColor=13F094" ></iframe>
          </div>
        </div>
      </div>
