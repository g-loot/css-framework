            ...
            <div className="flex gap-4 flex-col lg:flex-row lg:items-center">
              <div className="flex-1 space-y-4">
                ...
                <div className="text-center">
                  <button
                    ...
                    onClick={clickHandlerNum1and2.bind(this)}
                  >
              ...
              <div className="flex-1">
                <iframe
                  ...
                  width="100%"
                  height="300"
                  src="//jsfiddle.net/augustin_hiebel/2yuavgot/embedded/html/dark/?bodyColor=212333&menuColor=1C1D2C&fontColor=FFFFFF&accentColor=F3C351"
                ></iframe>
              </div>
            </div>
          </div>
            ...
            <div className="flex gap-4 flex-col lg:flex-row lg:items-center">
              <div className="flex-1 space-y-4">
                <div className="w-full flex gap-4 items-center justify-around">
                  <div className="gauge" style={{ "--percent": random1 }}>
                    ...
                    <div className="gauge-content">
                      <div className="text-xl font-bold">{random1}%</div>
                    </div>
                  </div>
                  <div className="gauge" style={{ "--percent": random2 }}>
                    <div className="gauge-chart">
              ...
              <div className="flex-1">
                <iframe
                  ...
                  width="100%"
                  height="300"
                  src="//jsfiddle.net/augustin_hiebel/v1379uk4/embedded/html/dark/?bodyColor=212333&menuColor=1C1D2C&fontColor=FFFFFF&accentColor=F3C351"
                ></iframe>
              </div>
            </div>
          </div>
