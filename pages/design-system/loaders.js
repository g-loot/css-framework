            ...
            <div className="flex gap-4 flex-col lg:flex-row lg:items-center">
              ...
              <div className="flex-1">
                <iframe
                  ...
                  width="100%"
                  height="300"
                  src="//jsfiddle.net/augustin_hiebel/9zhaL1or/embedded/html/dark/?bodyColor=333366&menuColor=1F1F42&fontColor=FFFFFF&accentColor=13F094"
                ></iframe>
              </div>
            </div>
          </div>
            ...
            <div className="flex gap-4 flex-col lg:flex-row lg:items-center">
              ...
              <div className="flex-1">
                <iframe
                  ...
                  width="100%"
                  height="300"
                  src="//jsfiddle.net/augustin_hiebel/9o0wqkLy/embedded/html/dark/?bodyColor=333366&menuColor=1F1F42&fontColor=FFFFFF&accentColor=13F094"
                ></iframe>
              </div>
            </div>
          </div>
