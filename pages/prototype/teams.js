...
const Teams = [
  {
    ...
    name: 'Team name',
    tag: 'GT2',
    avatar: 'https://res.cloudinary.com/gloot/image/upload/v1654063975/Marketing/2022_prototype/DummyContent/teams/teamlogo_CrocEsports.png',
    members: [
      {
  ...
  },
  {
    ...
    name: 'l10n',
    tag: 'LI',
    avatar: 'https://res.cloudinary.com/gloot/image/upload/v1654063976/Marketing/2022_prototype/DummyContent/teams/teamlogo_l10n.png',
    members: [
      {
    ...
    <>
      <PrototypeStructure title="Teams">
        ...
        <section className='mb-4'>
          <div className='surface md:rounded-lg p-4 lg:p-8 bg-cover bg-left' style={{ backgroundImage: 'url(https://res.cloudinary.com/gloot/image/upload/v1657121339/Marketing/2022_prototype/Teams_bg.webp)'}}>
            <div className=''>
        ...
        <section className='px-4 md:px-0'>
          ...
          <ul className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4'>
            {Teams.map((team, teamIndex) => (
                <>
                <li key={team} className='animate-slide-in-right animate-delay' style={{ '--delay': `calc( ${teamIndex} * 0.05s)`}}>
                    ...
                    <div className='rounded-full p-0.5 surface surface-ui-600 flex items-center pr-3'>
                      <div className="avatar-group -space-x-2 bg-ui-800 rounded-full">
                        {team.members.map((teamMember, teamMemberIndex) => (
                          <div key={teamMember} className="avatar avatar-simple avatar-circle avatar-xs">
                            <div className="">
