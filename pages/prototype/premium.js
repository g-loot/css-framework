      ...
      <PrototypeStructure title="Premium">
        <div className='animate-slide-in-bottom animate-delay' style={{ '--delay': 'calc( 2 * 0.05s)'}}>
          ...
          <section className="flex flex-col lg:flex-row lg:items-start justify-between text-center space-y-4 md:space-y-0 mb-24">
            <div>
              <img className='mx-auto block' src="https://res.cloudinary.com/gloot/image/upload/v1645610357/Marketing/202109_gloot2/premium-missions.png" width="400" height="auto" alt=""/>
            ...
            <div>
              <img className='mx-auto block' src="https://res.cloudinary.com/gloot/image/upload/v1645610357/Marketing/202109_gloot2/premium-rewards.png" width="400" height="auto" alt=""/>
              <h3 className="font-headings italic text-2xl text-gradient bg-gradient-to-b from-gold-300 to-gold-700">
                Earn mission<br />rewards faster
              </h3>
            </div>
            <div>
              <img className='mx-auto block' src="https://res.cloudinary.com/gloot/image/upload/v1645610357/Marketing/202109_gloot2/premium-ads.png" width="400" height="auto" alt=""/>
              <h3 className="font-headings italic text-2xl text-gradient bg-gradient-to-b from-gold-300 to-gold-700">
