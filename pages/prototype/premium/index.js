...
export default function Premium() {
  ...
  const premiumTableItems = [
    ...
    {
      name: "Extra tokens when purchasing",
    },
    {
      name: "25% XP Boost",
    },
        ...
        {isPremium ? (
          ...
          <>
            <section className="max-w-2xl mx-auto flex flex-col lg:flex-row items-stretch gap-8 mt-12 mb-24">
              ...
              <div className="flex-1 xl:flex-2">
                <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row items-stretch justify-around text-center gap-4 mt-8 mb-4">
                  <div>
                    <div
                      className="text-sm blockreveal animate-delay"
                      style={{
                        "--delay": "calc(6 * 0.05s)",
                      }}
                    >
                    ...
                    <div
                      className="h1 text-mono-100 text-6xl blockreveal animate-delay"
                      style={{
                        "--delay": "calc(8 * 0.05s)",
                      }}
                    >
            ...
            {premiumParagraphItems.map((item, itemIndex) => (
              <section
                key={itemIndex}
                className="max-w-2xl mx-auto flex flex-col md:flex-row items-center mb-24 animate-slide-in-bottom px-4 md:px-0"
              >
                <div
                ...
                >
                  <div
                    className="blockreveal animate-delay"
                    style={{
                      "--delay": "calc(4 * 0.05s)",
                    }}
                  >
                  ...
                  <p
                    className="my-2 text-premium-500 text-xl blockreveal animate-delay"
                    style={{
                      "--delay": "calc(8 * 0.05s)",
                    }}
                  >
                ...
                <figure
                  className={`flex-2 w-full relative z-10 order-2 animate-delay ${
                    itemIndex % 2 === 0
