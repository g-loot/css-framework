...
export default function LaddersHeader(props) {
  ...
  function openModalLadderHowitworksVideo() {
    uiContext.openModal(<ModalLadderHowitworksVideo />);
  }
          ...
          <section className="header surface sm:rounded-lg mb-4">
            ...
            <div className="header-content">
              ...
              <div
                ...
                onClick={() => setFreeEntry(!freeEntry)}
              >
                {freeEntry ? (
                  <>
                    ...
                    <p className="text-main mb-4">
                      ...
                      Your entry Ladder is on us! Simply pick any Ladder you
                      like and claim your free Ladder!
                    </p>
                  </>
                ) : (
                  <>
