          ...
          <div className="modal max-w-md">
            ...
            <div className="modal-content p-0">
              <div className="modal-body">
                ...
                <div className="flex items-center justify-between text-center md:text-left mb-4">
                  <h2 className="h4">{ladder.name}</h2>
                  <span className="icon text-3xl icon-rank-bronze text-gold-500"></span>
                </div>
                <h3 className="h6 text-ui-300 text-center mb-2">Top 3</h3>
                <div className="flex items-center justify-center gap-2 mb-8 px-0 md:px-10">
                  ...
                  <div className="w-full flex items-center justify-center bg-ui-850 rounded">
                    ...
                    >
                      <div className="flex items-center gap-6 whitespace-nowrap leading-tight">
                        <div className="px-4 py-2 text-center flex flex-col gap-3 items-center">
