                        ...
                        <li>
                          ...
                          >
                            ...
                            >
                              <a
                                href="#"
                                className="inline-flex gap-2 items-center text-sm text-ui-300 hover:text-ui-100 active:opacity-50 focus-visible:text-main focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-1 focus-visible:outline-main transition-colors duration-75 md:ml-2"
                              >
                                Tournaments
                              </a>
                            </Link>
                ...
                <div className="col-span-8 md:col-span-4 xl:col-span-3 flex flex-col justify-center items-center md:items-start text-center md:text-left flex-1 pl-8 md:pl-0 pr-8 py-0 md:py-4 xl:py-4">
                  ...
                  <div>
                    ...
                    <p className="text-ui-300 max-w-[45ch] flex items-center gap-2">
                      <span>Entry fee:</span>
                      {prototype.getTournamentByID(game, tournament_id).details.entryFee === "free" && (
                        <b>FREE</b>
                      )}
                      {prototype.getTournamentByID(game, tournament_id).details.entryFee !== "free" && (
                        <>
                        {prototype.getTournamentByID(game, tournament_id).details.entryFee.map((reward, rewardIndex) =>
                          <Reward key={rewardIndex} reward={reward} gap="gap-1.5" imageClassNames="h-6" textClassNames="text-ui-200 font-bold" />
                        )}
                        </>
                      )}
                    </p>
