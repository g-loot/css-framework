                  ...
                  {isPremium ? (
                    <>
                      {!isLoading && (
                        <>
                          {isEmpty ? (
                            <div className="mt-9 px-4 py-8 text-center">
                              <div className="max-w-xs mx-auto">
                                ...
                                <div className="mt-2 mb-6">
                                  ...
                                  <p className="text-lg text-ui-300">
                                    Change the filters to see more results.
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="mt-9 px-4 py-8 text-center">
                                ...
                                <p className="text-lg text-ui-300 mt-2 mb-6">
                                    Become Premium to access all scoreboards and filters.
                                  </p>
                    ...
                    <>
                      ...
                      {isLoading ? (
                        <ul className="items-spaced is-loading space-y-2">
                          {selectedScoreboard.players?.map(
                            (item, itemIndex) => (
