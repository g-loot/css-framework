...
export default function TabScoreboard(props) {
  ...
  return (
    <>
      {selectedScoreboard && (
        <>
          <section className="flex items-center gap-4 flex-wrap mb-4">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              <div className="col-span-1 hidden lg:block pt-9 space-y-4">
                <div className={`surface rounded text-center ${isLoading ? 'is-loading' : ''}`}>
                  ...
                  <div className="border-t border-ui-700 space-y-2 p-3">
                    ...
                    <p className="text-ui-300">#{selectedScoreboard.scores.placement}</p>
                    <button
                      type="button"
