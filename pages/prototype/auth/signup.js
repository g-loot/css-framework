...
export default function AuthLogin() {
  ...
  const [locationDropdownShown, setLocationDropdownShown] = useState(false);
  ...
  function handleLocation(event) {
    setLocationDropdownShown(false);
      ...
      <PrototypeAuth title="Login">
        <div className="p-4 w-full max-w-xs text-center">
          <img
            ...
            alt="Stryda logo"
          />
          <div className="form-group mb-6" data-success={isEmail(emailStr)}>
          ...
          <div className="form-group mb-6" data-success={checkAll(passwordStr)}>
          ...
          >
            <div className="flex items-center justify-between gap-4 mb-1">
              ...
              <Tooltip
                tooltip={
                  <div className="w-40 text-sm leading-tight">
                    Your nickname will be visible to other players on the
                    platform, e.g. your profile, leaderboards, and stats pages.
                  </div>
                }
              >
          ...
          <div className="form-group form-select text-left mb-6">
            <label htmlFor="favorite-game">My location</label>
            {!locationDropdownShown ? (
              <div className="flex items-center gap-4">
                <button
                  type="button"
                  className="chip chip-secondary w-full"
                  onClick={() =>
                    setLocationDropdownShown(!locationDropdownShown)
                  }
                >
                  <span>{selectedLocation}</span>
                  <span className="icon icon-sm icon-pen-2" />
                </button>
              </div>
            ) : (
              <select
          ...
          <Link href="/prototype/auth/step3">
            <button
              type="button"
              className="button button-primary w-full mt-2 mb-6"
