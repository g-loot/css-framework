              ...
              <div className="flex flex-col md:flex-row justify-around gap-4">
                ...
                <div className='flex-1'>
                  <div className='rounded overflow-hidden'>
                    <iframe width="100%" height="300" src="//jsfiddle.net/augustin_hiebel/nbdv342L/embedded/html/dark/" ></iframe>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='bg-ui-800 rounded-xl p-2'>
            ...
            <div className='p-4 border-t border-ui-600 mb-4'>
              <svg width="400" className='mx-auto block' height="auto" viewBox="0 0 825 606" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fillRule="evenodd" clipRule="evenodd" d="M8 394.111L126.094 352L247.3 393.379L227.709 549.555L126.094 605.764L26.126 550.288L8 394.111Z" fill="#E23237"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M247.3 393.379L126.094 352V605.764L227.71 549.555L247.3 393.379Z" fill="#B52E31"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M126.277 381.662L52.6742 545.346L80.1379 544.796L94.9682 507.812H126.277H160.698L176.81 545.163L202.992 545.712L126.277 381.662ZM126.46 434.209L151.36 486.207H127.558H126.277H104.672L126.46 434.209Z" fill="white"/>
                ...
                <path d="M127.076 174.203C193.944 174.203 248.151 153.506 248.151 127.974C248.151 102.442 193.944 81.7451 127.076 81.7451C60.2074 81.7451 6 102.442 6 127.974C6 153.506 60.2074 174.203 127.076 174.203Z" stroke="#61DAFB" strokeWidth="11.0069"/>
                <path d="M87.0405 151.084C120.475 208.993 165.503 245.589 187.614 232.824C209.725 220.058 200.545 162.764 167.111 104.855C133.677 46.945 88.649 10.3487 66.5381 23.1144C44.4272 35.8802 53.6064 93.1739 87.0405 151.084Z" stroke="#61DAFB" strokeWidth="11.0069"/>
                <path d="M87.0393 104.857C53.6052 162.767 44.4259 220.06 66.5369 232.826C88.6478 245.592 133.676 208.996 167.11 151.086C200.544 93.1765 209.723 35.8828 187.613 23.117C165.502 10.3512 120.473 46.9476 87.0393 104.857Z" stroke="#61DAFB" strokeWidth="11.0069"/>
